...
exports.categoryPageDetails = async (req,res) => {
    try {
      ...
      // // Get courses for other categories    *****comment ABM********
      ...
      if (categoriesExceptSelected.length > 0) {
        ...
        //console.log("No other categories with courses found.");
      }
      ...
      const allCategories = await Category.find()
        ...
        .exec()
      // const allCourses = allCategories.flatMap((category) => category.courses) ******comment ABM********
