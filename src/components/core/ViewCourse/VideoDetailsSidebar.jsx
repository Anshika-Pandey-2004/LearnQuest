...
const VideoDetailsSidebar = ({setReviewModal}) => {
  ...
  return (
    <>
        ...
        <div className="hidden h-[calc(100vh-3.5rem)]
                 sm:w-[40%] sm:flex
                md:w-[320px] md:max-w-[350px]
                flex-col border-r-[1px] border-r-richblack-700 bg-richblack-800">
            {/* for buttons and headings */}
            <div className="mx-5 flex flex-col items-start justify-between gap-2 gap-y-4 border-b border-richblack-600 py-5 text-lg font-bold text-richblack-25">
                {/* for buttons */}
                <div className="flex flex-col xs470:flex-row w-full items-center justify-between ">
                    <div 
                    onClick={()=> {
