...
const ExploreMore = () => {
  ...
  return (
    <div>
      ...
      {/* Heading text */}
        <div className='text-4xl font-semibold text-center flex flex-wrap justify-center'>
        Unlock the&nbsp; 
        <HighlightText text={"Power of Code"} />
      </div>

      {/* Sub-Heading text */}
      <div className='flex flex-col xs470:flex-row justify-center text-centerflex-row justify-center text-center text-richblack-300  text-lg font-semibold mt-3 mb-3 lg:mb-0 '>
