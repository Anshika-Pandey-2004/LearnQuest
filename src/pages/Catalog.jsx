        ...
        const getCategoryDetails = async() => {
            ...
            try{
                ...
                if (res.success) {
                    ...
                    //console.log("CATALOG PAGE DATA in component:", res); //*****ABM**** */
    ...
    if(loading){
        ...
        return (
            ...
            <div >
                ...
                {/* section2 */}
                {/* <div className=" mx-auto box-content w-full max-w-maxContentTab px-4 py-12 lg:max-w-maxContent"> ******COMMENTED BY ABM*******
                ...
                <div className="mx-auto box-content w-full max-w-maxContentTab px-4 py-12 lg:max-w-maxContent">
                    ...
                    <div className="py-8">
                    {catalogPageData.differentCourses.course?.length > 0 ? (
                        <CourseSlider Courses={catalogPageData.differentCourses.course} />
                    ) : (
                ...
                <div className="mx-auto box-content w-full max-w-maxContentTab px-4 py-12 lg:max-w-maxContent">
                    ...
                    No other category found to show.
                    </div>
                </div>
                )}
