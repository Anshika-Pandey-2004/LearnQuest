...
The LearnQuest ed-tech platform follows a client-server architecture with the following main components:
...
![System Architecture Diagram](https://github.com/yashsarode45/LearnQuest-Mega-Project/assets/65209607/3a154827-641d-4269-b662-203afcfd7654)

---

## Front-end

The front end of LearnQuest is built with ReactJS, offering a dynamic and responsive user interface for students and instructors. Here are some key pages and functionalities:
...
![LearnQuest1](https://github.com/yashsarode45/LearnQuest-Mega-Project/assets/65209607/ad992ea3-e257-404a-9d40-83183f7edfd3)
![LearnQuest2](https://github.com/yashsarode45/LearnQuest-Mega-Project/assets/65209607/87089177-e065-4b8a-8515-3af8e3aed4db)
...
The back end of LearnQuest is built with NodeJS and ExpressJS and uses MongoDB as its primary database. Key features and functionalities include:
...
LearnQuest's API follows the REST architectural style, implemented using Node.js and Express.js. It uses JSON for data exchange and standard HTTP request methods. Sample API endpoints include:
...
LearnQuest is deployed on various cloud-based services:
...
Thank you for using LearnQuest!
